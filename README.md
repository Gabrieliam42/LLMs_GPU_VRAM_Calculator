...
- For a 4B (4 Billion parameters) LLM you would need a GPU that has: at least 2.14GB VRAM for a 4-bit version of the model, OR at least 4.29GB VRAM for a 8-bit version of the model, OR at least 8.57GB VRAM for a 16-bit version of the model(FP16), and at least 17.13GB VRAM for a full 32-bit version of the model(FP32).
